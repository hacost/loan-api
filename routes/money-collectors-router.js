...
const controller = require('../controllers/money-collectors-controller');
const { createValidator, updateValidator, getValidator } = require('../validators/money-collectors-validator');
